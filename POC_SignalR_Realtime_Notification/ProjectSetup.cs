...
using POC_SignalR_Realtime_Notification.Configurations;
using POC_SignalR_Realtime_Notification.Data;
using POC_SignalR_Realtime_Notification.HostedServices;
using POC_SignalR_Realtime_Notification.Services;
using POC_SignalR_Realtime_Notification.Services.Auth;
using POC_SignalR_Realtime_Notification.Startups;
using Quartz;

namespace POC_SignalR_Realtime_Notification
{
